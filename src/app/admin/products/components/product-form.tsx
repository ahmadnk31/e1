...
// ... (keep existing type definitions for Category, Sale, Collection, Discount)
...
export const ProductForm = ({ categories, sales, collections, discounts,brands }: ProductFormProps) => {
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    startTransition(async () => {
      try {
        ...
        const res = await axios.post(`/api/products`, formattedValues);
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            {/* Keep existing category, collection, discount, sale selects */}
            <FormField
            control={form.control}
            name="categoryId"
            render={({ field }) => (
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-1 gap-2">
                      ...
                      onClick={() => {
                        const variants = form.getValues('variants');
                        const updatedVariants = variants ?? [];
                        updatedVariants[index].attributes = updatedVariants[index].attributes.slice(0, -1);
                        form.setValue('variants', updatedVariants);
                      }}
                    >
                      <X className="w-4 h-4" />
