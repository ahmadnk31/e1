...
export const SaleCell = ({ 
  ...
  const handleSaleChange = async (newSaleId: string) => {
    ...
    try {
      ...
      const response = await axios.patch(`/api/categories/${categoryId}`, updateData)
...
type Discount = {
  ...
  export const CategoryDiscountCell = ({ 
    categoryId, 
    currentDiscountId, 
    discounts, 
    onDiscountChange,
    ...
    const handleDiscountChange = async (newDiscountId: string) => {
      ...
      try {
        ...
        toast.error("Failed to category  discount")
        if (axios.isAxiosError(error)) {
          console.error('Axios error:', {
            message: error.message,
            response: error.response?.data,
  ...
  type Collection = {
    ...
    export const CategoryCollectionCell = ({ 
      categoryId, 
      currentCollectionId, 
      collections, 
      onCollectionChange,
